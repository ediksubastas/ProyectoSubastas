  ...
  <?php
    ...
    if(isset($_POST["guardar"])){
      ...
      if($foto == null){
        ...
        $res = $bd->query("UPDATE usuario set nombre='$nombre', paterno='$paterno', materno='$materno', fechanac='$fechanac',
                          correo='$correo', user='$user', pass='$pass', direccion='$direccion', telefono='$telefono' where id_usuario=$id_usuario;");
        ...
        $dest = "images/perfiles/";
        copy($ruta,$dest.''.$foto);

        $res = $bd->query("UPDATE usuario set nombre='$nombre', paterno='$paterno', materno='$materno', fechanac='$fechanac',
                          foto='$foto', correo='$correo', user='$user', pass='$pass', direccion='$direccion', telefono='$telefono' where id_usuario=$id_usuario;");
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" name="correo" class="form-control" value="<?php echo $direccion; ?>" required>
                          </div>

                          <div class="form-group">
                              <label>Telefono</label>
                              <input type="number" name="telefono" class="form-control" value="<?php echo $telefono; ?>" required>
                          </div>
