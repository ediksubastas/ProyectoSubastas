 ...
 <!-- PIE O FOOTER DE LA PAGINA -->
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b>Version</b> 1.0
    </div>
    <strong>Copyright &copy; 2020-2021 <a href="http://almsaeedstudio.com">EBRAVO</a>.</strong> All rights
    reserved.
  </footer>
...
<script src="../Public/dist/js/Funcionesjs.js"></script>
</body>
</html>